...
_PROPULSIONTASKSTATISTICS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=b'\200\265\030\007', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='min_interval', full_name='goldo.nucleo.statistics.PropulsionTaskStatistics.min_interval', index=1,
      number=5, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\200\265\030\007', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='max_interval', full_name='goldo.nucleo.statistics.PropulsionTaskStatistics.max_interval', index=2,
      ...
      serialized_options=b'\200\265\030\007', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='queue', full_name='goldo.nucleo.statistics.PropulsionTaskStatistics.queue', index=3,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='urgent_queue', full_name='goldo.nucleo.statistics.PropulsionTaskStatistics.urgent_queue', index=4,
      number=3, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='odrive_queue', full_name='goldo.nucleo.statistics.PropulsionTaskStatistics.odrive_queue', index=5,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
MessageQueueStatistics = _reflection.GeneratedProtocolMessageType('MessageQueueStatistics', (_message.Message,), {
...
CommSerializerStatistics = _reflection.GeneratedProtocolMessageType('CommSerializerStatistics', (_message.Message,), {
...
CommDeserializerStatistics = _reflection.GeneratedProtocolMessageType('CommDeserializerStatistics', (_message.Message,), {
...
ODriveStreamParserStatistics = _reflection.GeneratedProtocolMessageType('ODriveStreamParserStatistics', (_message.Message,), {
...
ODriveStreamWriterStatistics = _reflection.GeneratedProtocolMessageType('ODriveStreamWriterStatistics', (_message.Message,), {
...
UARTCommTaskStatistics = _reflection.GeneratedProtocolMessageType('UARTCommTaskStatistics', (_message.Message,), {
...
ODriveCommTaskStatistics = _reflection.GeneratedProtocolMessageType('ODriveCommTaskStatistics', (_message.Message,), {
...
PropulsionTaskStatistics = _reflection.GeneratedProtocolMessageType('PropulsionTaskStatistics', (_message.Message,), {
...
_PROPULSIONTASKSTATISTICS.fields_by_name['min_interval']._options = None
_PROPULSIONTASKSTATISTICS.fields_by_name['max_interval']._options = None
