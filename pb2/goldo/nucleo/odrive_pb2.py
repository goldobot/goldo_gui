...
_TELEMETRY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=b'\210\265\030\002\220\265\030\001', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
  ],
  extensions=[
  ],
  nested_types=[],
...
AxisTelemetry = _reflection.GeneratedProtocolMessageType('AxisTelemetry', (_message.Message,), {
...
AxisErrorState = _reflection.GeneratedProtocolMessageType('AxisErrorState', (_message.Message,), {
...
AxisState_ = _reflection.GeneratedProtocolMessageType('AxisState_', (_message.Message,), {
...
AxisErrorStates = _reflection.GeneratedProtocolMessageType('AxisErrorStates', (_message.Message,), {
...
AxisStates = _reflection.GeneratedProtocolMessageType('AxisStates', (_message.Message,), {
...
ClientStatistics = _reflection.GeneratedProtocolMessageType('ClientStatistics', (_message.Message,), {
...
ODriveStatus = _reflection.GeneratedProtocolMessageType('ODriveStatus', (_message.Message,), {
